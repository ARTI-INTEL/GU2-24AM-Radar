...
//   Writes timestamped entries to fixed log files inside the /logs directory.
//
//   Log files produced:
//     logs/access.log  — one line per HTTP request (method, url, status, ms)
//     logs/app.log     — general INFO messages (startup, polls, cleanup)
